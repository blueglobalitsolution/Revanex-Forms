...
function shareForm(formId) {
    ...
    const embed = `<iframe src="${window.location.origin}/form.html?id=${formId}" width="100%" height="800" frameborder="0" style="border:1px solid #fbfbf2;border-radius:10px;max-width:720px;margin:0 auto;display:block"></iframe>`;
